"""Sphinx configuration for the OSQAr Python hello_world example."""
...
#
# The JUnit XML is generated by `./build-and-test.sh`. We intentionally do not
# commit generated test result artifacts, so documentation builds must tolerate
# this file being absent.
