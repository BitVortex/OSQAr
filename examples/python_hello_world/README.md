# OSQAr Example (Python): Temperature Monitor (TSIM)
...
This **Python** variant is optimized for being easy to run on a developer workstation. It demonstrates traceability mechanics and test-result import, but it is **not suited to safety-related embedded targets**.

For safety-related embedded projects, prefer **C** or **Rust**. **C++** is common in industry, but is not recommended here as a starting point.
