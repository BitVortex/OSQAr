"""Sphinx configuration for the OSQAr hello_world example."""
...
# Test results import (sphinx-test-reports reads this file)
test_results_file = 'test_results.xml'

# sphinx-test-reports (imports JUnit XML into the docs when the extension is installed)
