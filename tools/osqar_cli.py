...
"""
    ...
    for it in projects:
        ...
        lines.append("\n   * - " + project_cell + "\n")
        lines.append("     - " + cell(version) + "\n")
        lines.append("     - " + cell(origin_val) + "\n")
        lines.append("     - " + cell(n_total) + "\n")
        lines.append("     - " + cell(n_req) + "\n")
        lines.append("     - " + cell(n_arch) + "\n")
        lines.append("     - " + cell(n_test) + "\n")
        lines.append("     - " + cell(checksums_rc) + "\n")
        lines.append("     - " + cell(trace_rc) + "\n")
...
"""
    ...
    (source_dir / "overview.rst").write_text("".join(lines), encoding="utf-8")
