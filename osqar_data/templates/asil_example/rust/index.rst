ASIL Target Example (Rust)
==========================

This is an incomplete Rust SEooC example whose **target** is ASIL D. It shows
how standards claims can link to draft project requirements, architecture,
...
1. Build and test the Rust library with ``./build-and-test.sh test``.
